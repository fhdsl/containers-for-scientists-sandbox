...
<input type="checkbox"> Now we can run the folowing command but we will have to run `docker ps` and get the container ID we need to put here.   
```
...
## Podman
### Set up Podman and workshop files
<input type="checkbox"> Download the files for this activity by going here: https://github.com/fhdsl/containers-for-scientists-sandbox  
<input type="checkbox"> Click the green button that says "Code" and choose zip file.  
<input type="checkbox"> Double click or right click and choose "unzip" or "decompress" to unzip this file.  
